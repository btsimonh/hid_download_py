...
FLASH_ID_TH25Q_16HB=0x001560eb      # EN25QH16B
...
tblFlashInt = [
    ...
    FlashInt(FLASH_ID_XTX_25Q128B,    "XT25Q128B",    "xtx",    128 *1024*1024,   3,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0x15,0xff],   [0x01,0x31,0x11,0xff]),
    FlashInt(FLASH_ID_XTX_25F128F,    "XT25F128F",    "xtx",    128 *1024*1024,   3,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0x15,0xff],   [0x01,0x31,0x11,0xff]),
    FlashInt(FLASH_ID_Puya_25Q40,     "P25Q40",       "Puya",     4 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q80,     "P25Q80",       "Puya",     8 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q80_38,  "P25Q80",       "Puya",    16 *1024*1024,   1,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q16HB_K, "P25Q16HB_K",   "Puya",    16 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q16SU,   "P25Q16SU",     "Puya",    16 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q32H,    "P25Q32H",      "Puya",    32 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q64H,    "P25Q64H",      "Puya",    64 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_Puya_25Q128HA,  "P25Q128HA",    "Puya",   128 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0x31,0xff,0xff]),
    FlashInt(FLASH_ID_GT25Q16B,       "GT25Q16B",     "GT",      16 *1024*1024,   3,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0x15,0xff],   [0x01,0x31,0x11,0xff]),
    ...
    FlashInt(FLASH_ID_DS_ZB25LQ128C,  "DS_ZB25LQ128C","WB",     128 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0x15,0xff],   [0x01,0x31,0x11,0xff]),
    ...
    FlashInt(FLASH_ID_ESMT_25QE32A,   "EN25QH32A",    "ESMT",    32 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    ...
    FlashInt(FLASH_ID_GD_25Q41B_T,    "GD25Q41B",     "GD",       4 *1024*1024,   1,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,3),   2,    3,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    ...
    FlashInt(FLASH_ID_GD_25WD80E,     "GD25WD80E",    "GD",       8 *1024*1024,   1,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0xff,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    ...
    FlashInt(FLASH_ID_GD_25Q64,       "GD25Q64",      "GD",      64 *1024*1024,   1,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    FlashInt(FLASH_ID_GD_25LQ128E,    "GD25LQ128E",   "GD",     128 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    FlashInt(FLASH_ID_GD_25WQ128E,    "GD25WQ128E",   "GD",     128 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    FlashInt(FLASH_ID_GD25LX256E,     "GD25LX256E",   "GD",     256 *1024*1024,   1,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0xff,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    FlashInt(FLASH_ID_TH25D_40HB,     "TH25D_40HB",   "TH",       4 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
    ...
    FlashInt(FLASH_ID_XM25QU128C,     "XM25QU128C",   "XMC",    128 *1024*1024,   2,    0x00,    0x07,   BIT(14)|BFD(0x1f,2,5),   2,    5,    [0x05,0x35,0xff,0xff],   [0x01,0xff,0xff,0xff]),
